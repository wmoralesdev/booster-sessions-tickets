        ...
        <div className="w-64 h-96 border-2 border-white rounded-xl shadow-lg flex flex-col">
            ...
            <div className="w-full h-full flex flex-col justify-between items-center space-y-2">
                <div className="space-y-6">
                    ...
                    <div className="flex flex-col items-center space-y-4">
                        <p className="text-sm text-center">Join us via <br/>
                            <strong><Icon icon={faYoutube}/> YouTube</strong>
                        </p>
                    </div>
                    <div className="flex flex-col items-center space-y-1">
                        <p className="text-xs text-center px-4 font-medium">Algorithms and Data Structures</p>
                        <p className="text-xs text-center px-4 font-medium">Tuesday 21st, 2021</p>
                        <p className="text-xs text-center px-4 font-medium">Hosted by <br/>
                        <strong>Walter Morales</strong>
                        </p>
                    </div>
                </div>
                <div className="w-full space-x-4 text-center pt-8">
                        <Icon className="text-white h-5" icon={faInstagram}/>
                        <Icon className="text-white h-5" icon={faFacebook}/>
                        <Icon className="text-white h-5" icon={faTwitter}/>
                </div>
                <div className="mt-auto bg-white w-full rounded-b-lg text-2xl text-primary font-bold text-center py-2 flex flex-wrap justify-center space-x-3">
                    <Elaniin/>
                    <span>#000001</span>
                </div>
            </div>
